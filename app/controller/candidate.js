...
import filter from '#app/controller/candidate/filter.js?v=30';
import search from '#app/controller/candidate/search.js?v=30';
	...
	(`
		<div class=content>
			...
			<div id=link class=list>
				...
				<a class="${named}" href="${def.link.agitate.url}">${def.link.agitate.txt}</a>
